...
import { addUser, selectUsersList, addClient, addFreelancer } from '../../store/slices/slices.js';
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // generate new user_id based on existing users
    ...
    const newUser = {
      ...
      profile_image: profilePreview || '/img/default.png',
    ...
    // Add to clients or freelancers slice depending on role
    if (formData.role === 'client') {
      dispatch(addClient({
        client_id: newUserId, // same as user_id
        user_id: newUserId,
      ...
      dispatch(addFreelancer({
        freelancer_id: newUserId,
        user_id: newUserId,
        skills: formData.bio || '',
    ...
    navigate(formData.role === 'client' ? '/client' : '/freelancer');
  };
    ...
    <div className="h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex flex-col overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-200 py-4 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 hidden lg:block">
                Empowering Productivity, Fueling Creativity, Driving Growth
              </p>
          ...
          <div className="text-sm text-gray-600">
            ...
            <NavLink className="font-semibold text-indigo-600 hover:text-indigo-500" to={'/login'}>Sign in</NavLink>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto p-6">
          <div className="bg-white rounded-2xl shadow-[1px_-1px_2px_1px_blue] p-8">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button type="button" onClick={() => setFormData({ ...formData, role: 'client' })} className={`p-4 border-2 rounded-xl transition-all ${formData.role === 'client' ? 'border-indigo-500 bg-indigo-50 shadow-md' : 'border-gray-200 hover:border-gray-300'}`}>
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <p className="font-semibold text-gray-900">Hire Freelancers</p>
                      <p className="text-xs text-gray-500">Post jobs & manage teams</p>
                    </div>
                  </button>
                </div>
              </div>
              ...
              {/* Submit */}
              <div className="mt-6">
                <button type="submit" className="w-full px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-md transition-all">
                  Create Account
                </button>
              </div>
            </form>
