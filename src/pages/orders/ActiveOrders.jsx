        ...
        <div className="min-h-screen bg-gray-50 px-4 py-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <NavLink to={"../all-orders"} className="text-sm text-indigo-600 hover:text-indigo-700 font-semibold">
                        View All Orders →
                    </NavLink>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  gap-6">
                    {activeOrders.map((order) => {
                        ...
                        if (order.offer_id !== -1) {
                            ...
                            title = "Custom Order";
                            description = "This is a custom order without a predefined job or offer.";
                            category = "Custom";
                            type = "custom";
                        }
